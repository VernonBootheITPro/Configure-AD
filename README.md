...
Thats is it ! In the [next tutorial](https://github.com/VernonBootheITPro/Network-Security-Groups-NSGs-and-Inspecting-Network-Protocols), we will go over various network traffic to and from Azure Virtual Machines with Wireshark as well as experiment with Network Security Groups.
